...
export type ChannelHandlerFunction<B, R> = (body: B, respond: ((response: R) => void) | undefined, ev: string, params: Record<string, any>) => any;
...
function compilePattern(pattern: string): { regex: RegExp; keys: string[]; segmentCount: number; hasWildcards: boolean } {
